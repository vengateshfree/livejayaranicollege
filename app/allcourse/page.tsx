...
const courseSections = [
  // ✅ UG
  {
    ...
    data: [
      { name: "B.Sc. Computer Science (AI & DS)", desc: "AI & Data Science specialization", path: "/allcourse/bsc-ai-ds", icon: Brain, image: "https://images.unsplash.com/photo-1534759846116-5799c33ce22a?q=80&w=1200&auto=format&fit=crop" },
      { name: "B.Sc. Computer Science", desc: "Core computing & programming", path: "/allcourse/bsc-cs", icon: Laptop, image: "https://images.unsplash.com/photo-1518770660439-4636190af475?q=80&w=1200&auto=format&fit=crop" },
      { name: "B.Sc. Mathematics", desc: "Mathematics & analytical thinking", path: "/allcourse/bsc-maths", icon: Calculator, image: "https://images.unsplash.com/photo-1509228468518-180dd4864904?q=80&w=1200&auto=format&fit=crop" },
      { name: "B.Sc. Physics", desc: "Fundamentals of physical sciences", path: "/allcourse/bsc-physics", icon: Globe, image: "https://images.unsplash.com/photo-1636466497217-26a8cbeaf0aa?q=80&w=1200&auto=format&fit=crop" },
      { name: "B.Com. Computer Applications", desc: "Commerce integrated with IT", path: "/allcourse/bcom-ca", icon: Laptop, image: "https://images.unsplash.com/photo-1519389950473-47ba0277781c?q=80&w=1200&auto=format&fit=crop" },
      { name: "B.Com. General", desc: "Business, finance & accounting basics", path: "/allcourse/bcom", icon: TrendingUp, image: "https://images.unsplash.com/photo-1554224155-6726b3ff858f?q=80&w=1200&auto=format&fit=crop" },
